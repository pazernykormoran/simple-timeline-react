  ...
  return (
    <div>
      ...
      <div style={{ float: "left", margin: "20px" }}>
        <DenseTable items={items2}></DenseTable>


        {/* <button onClick={addItem}>Dodaj Wydarzenie</button> */}
