...
export const example_items = [{
    ...
    media: {
        ...
        source: {
            url: "http://91.227.64.92/simple-timeline-main/img/prototype2.jpg"
        }
    }
},
{
